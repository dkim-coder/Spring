...
public class BookController {
    ...
    public String showList(Model model) {
        ...
        books.add(new Book("111-222-333", "홍길동", "책제목1", 10000, "좋은 책1", "abc1.png"));
        books.add(new Book("111-222-444", "임꺽정", "책제목2", 20000, "좋은 책2", "abc2.png"));
        books.add(new Book("111-333-444", "장길산", "책제목3", 30000, "좋은 책3", "abc3.png"));
        // 저장
     ...
     */
//    @PostMapping("/regist")
//    public String doRegist(Book book, Model model) {
